export const MESSAGES = {
  ...
  // Создание встречи
  CREATE_EVENT_TITLE: 'Этап 1/8: Введите название встречи:',
  CREATE_EVENT_START_DATE: 'Этап 2/8: Введите дату начала (ДД.ММ.ГГГГ, ЧЧ:ММ):',
  CREATE_EVENT_END_DATE: 'Этап 3/8: Введите дату окончания (ДД.ММ.ГГГГ, ЧЧ:ММ):',
  CREATE_EVENT_DESCRIPTION: 'Этап 4/8: Введите описание встречи:',
  CREATE_EVENT_PAYMENT_ONSITE: 'Этап 5/8: Настройка оплаты\nРазрешить оплату на месте?',
  ...
  CREATE_EVENT_ADVANCE_DEADLINE: 'Этап 7.1/8: Введите крайний срок оплаты заранее (ДД.ММ.ГГГГ, ЧЧ:ММ):',
